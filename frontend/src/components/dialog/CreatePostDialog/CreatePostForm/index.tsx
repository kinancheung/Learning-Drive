...
/**
 * Interface prop to handle new posts or editing existing posts
 */
...
/**
 * Form to create or edit a post containing a message, link to site, and categories
    ...
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(handleSubmit)}>
        <Stack spacing={2} sx={{ mt: 1 }}>
          ...
          />
          {allowCategories && <CategorySelect name='categories' label='Categories' allowCreate />}
          <SubmitButton
            color='primary'
            variant='contained'
            size='large'
